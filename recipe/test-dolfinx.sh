...
# skip tests that rely on cppimport (for now)
export PYTEST_ADDOPTS="${PYTEST_ADDOPTS} --ignore unit/fem/test_assemble_cppimport.py --ignore unit/common/test_mpi.py --ignore unit/la/test_casters.py"
